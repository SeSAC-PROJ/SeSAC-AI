...
class PresentationFeedbackBot:
    ...
    def build_prompt(self, analysis: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "2. **detailed_feedback** : 아래 예시처럼, 시간 구간(초 단위, 예: 5~10초)을 명시하여 구체적으로 작성합니다. "
            "시선, 자세, 감정, 발음·음성 등에서 칭찬도 포함하세요. 대화 없이 코치 입장에서 일방적으로 피드백하세요.\n\n"
            "예시:\n"
            "- **[시선]** 5~10초: 시선이 자주 바닥을 향하고 있음. 발표할 때 카메라를 더 자주 바라보세요.\n"
            "- **[자세]** 12~20초: 몸이 좌우로 살짝 흔들렸으니 자세를 한 번 점검해 보세요.\n"
            "- **[발음/음성]** 30~45초: 이 구간은 목소리 톤과 발음이 매우 좋았습니다. 계속 유지하세요!\n"
            "- **[기타]** 50~60초: 대본을 자주 보는 모습이 관찰됨. 발표 내용을 미리 더 숙지하면 좋겠습니다.\n\n"
